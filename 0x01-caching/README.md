# 0x01-caching
Learn caching and caching mechanisms for backend

### [basic_caching.py](./basic_caching.py)
Contains class BasicCaching that serves as the base for cache services
